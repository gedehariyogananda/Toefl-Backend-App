...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <br>
            <p>Please verify your email by entering the OTP code below:</p>
            <div class="otp">{{ $validTokenRegister }}</div>
        ...
        <div class="footer">
            <p>If you encounter any issues, please contact pentol.verify@gmail.com.</p>
        </div>
    </div>
</body>
